...
<!-- Content area -->
<div class="content">
	<form action="<?php echo base_url('admin/products/edit/').$product['id']; ?>" id="productform" method="POST">
		<div class="row">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="<?php _el('product_name'); ?>" id="name" name="name" value="<?php echo $product['name']; ?>">
								</div>
								<div class="form-group">						
									<label><?php _el('description'); ?>:</label>
									<input type="text" class="form-control" placeholder="<?php _el('description'); ?>" id="description" name="description" value="<?php echo $product['description']; ?>">
								</div>
							</div>
						</div>
					</div>
